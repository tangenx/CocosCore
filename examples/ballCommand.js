...
module.exports = new BallCommand({
    ...
    handler(ctx) {
        ...
        */
        ...
        const phrases = ['возможно.', 'да.', 'определённо -- да.', 'нет.', 'скорее да, чем нет', 'забудь об этом.', 'туманный ответ, попробуй ещё.', 'даже не думай.', 'я думаю, да', 'думаю, нет.', 'лучше пока не знать об этом.', 'ты шутишь?', 'ни в коем случае.', 'быть может.', '100% да.', 'скорее нет, чем да.'];
